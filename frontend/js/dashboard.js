...
Object.assign(window, {
  _checkAppStatusRun, addManualYtdAccount, addParentheticals, addYtdTxn,
  allocationPreviewFingerprint, allocationPreviewRowsForPost, allocationTargetsValid,
  artifactHashFromPreflight, assetActionForSubsection, autoCollapseHelpForNarrowLaptop,
  ...
  choiceHelpText, choiceLabel, choiceOptions, chooseDefaultDetailedSheet, clientDataKey,
  cloneSummary, closeChartModal, closeExitModal, closeNavDrawer, collapseAllDetailGroups, csvEscape,
  currentManualOverrideItems, currentScenarioOverrideItems, decimalsFromText,
  deduplicateYtdTransactions, deleteAllYtdTransactions, deleteYtdAccount, deleteYtdTxn,
  ...
  downloadYtdTemplate, exitApp, expandAllDetailColumnsOnPage, expandAllDetailGroups,
  fetchPlanDataFiles, fetchText, fetchWithTimeout, fieldAllowedValues, fieldConnection,
  ...
  filterChoiceOptionsForRow, finiteOrNull, focusYtdAccountMoney, focusYtdTxnAmount, focusableEntries,
  ...
  importPreviewList, leverPctPoints, loadCanonicalGlossary, loadDetailedResults, makeYtdAccountRow,
  mergeDetailedSheetMeta, mergeProtectedClientData, moneyNegativeClass, moveToNextEntry,
  normalizePlanDataTextForCompare, normalizePlanningCaseRunType, normalizePlanningCaseSource,
  normalizeValueForSave, normalizeYtdActualsPeriod, noteSessionFieldChange, noteSpecialSessionChange,
  numberDisplayDecimals, openCachedChart, openExitModal, openNavDrawer, openNextCollapsedSectionFrom,
  optionalModuleState, pageHelp, pageSaveMode, pageSaveModeHtml, pageStatusHtml, parseCsvLine,
  ...
  renderEstateWithAnnuityLink, renderFieldFinderGroups, renderHouseholdPeople, renderIncomeWork,
  renderMeta, renderNav, renderOptionalFunctions, renderPlanningWorkbench, renderRetirementWellness,
  ...
  renderWorkspaceSubtabsNav, renderYtdDuplicateReview, renderYtdSummary, renderYtdTracking,
  renderYtdTransactions, renderYtdTransactionsStep, renderYtdUploadPanel, resetAllocationPreview,
  resetYtdTxnPage, restoreGroupBudgetModes, restoreWorkbookViewState, revertLastBuildChanges,
  rollForwardYtdAccounts, rowConfigValue, rowIsRetirementWellness, rowSortKeyForIncomeWork,
  saveAndExit, saveChanges, saveCurrentPlanToSelectedFolderForBuild, saveLiabilities,
  saveValueForRow, saveYtdAccountSetup, saveYtdPending, saveYtdTransactions, scenarioRowKeyFromParts,
  sectionFlagEnabled, selectedFolderDiffersFromLoadedPlan, serializeCsvTable, serializeLiabilities,
  setAllDetailColumnGroups, setCombinedSearch, setDetailedResultSheet, setDetailedResultsNavOpen,
  setNavSearch, setPlanningCaseActive, setSearchScope, setStrategyTab, setYtdActualsPeriod,
