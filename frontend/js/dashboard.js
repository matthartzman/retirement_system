...
Object.assign(window, {
  ...
  addManualYtdAccount, addParentheticals, addSelectedYtdAccount, addUniqueRow, addYtdAccount,
  addYtdTxn, allocationCommonRows, allocationCoverageCalloutHtml, allocationModeHtml,
  ...
  allocationRowsOrNote, allocationTargetsValid, alternateAssetRows, alternateAssetSourceOptions,
  alternateSelect, applySavedScenarioSet, applyScenarioTemplate, artifactHashFromPreflight,
  assetActionForSubsection, assetClassNamesForAllocation, autoCollapseHelpForNarrowLaptop,
  baseHomeSaleYearRow, blurYtdAccountMoney, blurYtdTxnAmount, boolishValue, budgetSectionIsSummary,
  budgetSectionLines, buildChangeSummaryHtml, buildHistoryEntryHtml, buildHistoryProvenanceHtml,
  buildImpactCardsHtml, buildImpactNarrativeHtml, buildImpactSourceLinksHtml,
  buildImpactSuggestionsHtml, buildKpiDial, buildSessionSummaryHtml, buildSourceJumpHtml,
  ...
  chooseDefaultDetailedSheet, classKey, clearHousingNextStep, clientDataKey, cloneSummary,
  closeChartModal, closeExitModal, closeNavDrawer, closeoutItem, collapseAllDetailGroups,
  ...
  deleteSavedScenarioSet, deleteYtdAccount, deleteYtdTxn, dependencyRank, deriveTotalRothConversions,
  ...
  downloadYtdTemplate, ensurePlanFolderPermission, estimateHousingFromState, exitApp,
  ...
  loadCanonicalGlossary, loadDetailedResults, loadSavedPlan, loadTaxFreshnessStatus, logoutSaas,
  makeYtdAccountRow, markMatrixDirty, matrixKey, matrixPolicies, matrixYears, mcEngineRow,
  mcEngineToggleHtml, mergeDetailedSheetMeta, mergeProtectedClientData, mhBool, mhMoney, mhOnOff,
  mhPct, mhRow, mhText, modelHeardHtml, moneyHtml, moneyNegativeClass, moveToNextEntry, nbaPanelHtml,
  normalizePlanDataTextForCompare, normalizePlanningCaseRunType, normalizePlanningCaseSource,
  normalizeValueForSave, normalizeYtdActualsPeriod, normalizedAssetSourceName,
  noteSessionFieldChange, noteSpecialSessionChange, numberDisplayDecimals, openCachedChart,
  openCurrentPlan, openDemoPlan, openExitModal, openNavDrawer, openNextCollapsedSectionFrom,
  openPathPrompt, openSystemAdmin, openSystemConfigurationConsole, optimizerInputRows,
  ...
  renderCollapsibleDomainBudgetSection, renderCurrentAllocationModeNote,
  ...
  renderSpendingDashboardOrLoad, renderSpendingHousing, renderSpendingWorkflowBanner,
  renderSsCompactTable, renderSsPolicySection, renderStateResidency, renderStrategyTabs,
  renderStressSellHomeRows, renderSurvivorStress, renderSystemConfiguration, renderTabbedWorkspace,
  ...
  revealAndFocus, revealInactiveRow, revertLastBuildChanges, revertToBuildHistoryEntry,
  rollForwardYtdAccounts, rothPageRecommendations, rothPolicyValue, rowConfigValue,
  rowIsCanonicalHomeBasis, rowIsEconomyScenario, rowIsHomeSaleAssumption, rowIsRentInput,
  rowIsRetirementWellness, rowSortKeyForIncomeWork, rowValueIsMeaningful, rowsByLabel, rowsNotIn,
  saveAndExit, saveBuildHistory, saveChanges, saveCurrentPlanToSelectedFolderForBuild,
  saveCurrentScenarioSet, saveLiabilities, savePlanAs, savePlanDataToFolder, savePlanDataToPath,
  saveSpendingBudgetAll, saveSpendingSetupAll, saveValueForRow, saveYtdAccountSetup, saveYtdPending,
  saveYtdTransactions, scenarioActiveOverrideItems, scenarioCurrentItems, scenarioDiffTableHtml,
  scenarioRowKeyFromParts, scenarioSetDiffItems, scenarioTemplateById, scenarioTemplateDiffItems,
  scenarioWriteSets, sectionFlagEnabled, seedHousingRows, seedWellnessOop, selectPlanDataForImport,
  ...
  setDetailedResultsNavOpen, setMcEngineMode, setNavSearch, setPlanningCaseActive,
  setPlanningLeverInput, setSearch, setSearchScope, setSelectionAction, setStrategyTab,
  setYtdActualsPeriod, setYtdSort, setYtdTxnPage, shortHash, showConfigCardHelp,
  ...
  sourceStepForSpecialLabel, spendingFlowFooterHtml, spendingPageRecommendations, ssActiveCell,
  ssClaimFactor, ssMonthlyAtClaimAgeCell, ssPersonRows, startDetailedResultsProgress, startNewPlan,
