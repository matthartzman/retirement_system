...
Object.assign(window, {
  ...
  boolishValue, buildChangeSummaryHtml, buildHistoryEntryHtml, buildHistoryProvenanceHtml,
  buildImpactCardsHtml, buildImpactNarrativeHtml, buildImpactSourceLinksHtml,
  buildImpactSuggestionsHtml, buildKpiDial, buildSourceJumpHtml, buildWithDesktopProgress,
  ...
  deleteAllYtdTransactions, deleteBuildHistoryEntry, deleteLargeDiscLine, deleteYtdAccount,
  ...
  impactCardHtml, impactDirectionWord, importPreviewList, incomeStreamSubsections, irmaaModeValue,
  jumpRecommendationSource, kpiHasValues, largeDiscCategoryFromType, largeDiscTypeFromLine,
  latestBuildImpactHtml, leverPctPoints, loadCanonicalGlossary, loadDetailedResults, loadSavedPlan,
  loadTaxFreshnessStatus, makeYtdAccountRow, matrixPolicies, matrixYears, mcEngineRow,
  mcEngineToggleHtml, mergeDetailedSheetMeta, mergeProtectedClientData, mhBool, mhMoney, mhOnOff,
  mhPct, mhRow, mhText, modelHeardHtml, moneyNegativeClass, moveToNextEntry, nbaPanelHtml,
  ...
  openSystemConfigurationConsole, optimizerOverrideTotalHtml, optimizerPreviewStatusCell,
  optimizerPreviewTarget, optionalModuleState, orderedRowsByLabel, pageHelp,
  pageRecommendationsForStep, pageRecommendationsHtml, pageSaveMode, pageSaveModeHtml,
  ...
  rowSortKeyForIncomeWork, saveAndExit, saveBuildHistory, saveChanges,
  saveCurrentPlanToSelectedFolderForBuild, saveLiabilities, savePlanAs, saveValueForRow,
