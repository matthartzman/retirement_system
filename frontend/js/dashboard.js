...
Object.assign(window, {
  ...
  addUniqueRow, addYtdAccount, addYtdTxn, allocationCommonRows, allocationCoverageCalloutHtml,
  allocationModeHtml, allocationModeIsComputed, allocationOptimizerRecommendationHtml,
  allocationPageRecommendations, allocationPolicyRows, allocationPreviewFingerprint,
  allocationPreviewRowsForPost, allocationRowsOrNote, allocationTargetsValid, alternateAssetRows,
  alternateAssetSourceOptions, alternateSelect, applySavedScenarioSet, applyScenarioTemplate,
  ...
  choiceOptions, chooseDefaultDetailedSheet, classKey, clearHousingNextStep, clientDataKey,
  cloneSummary, closeChartModal, closeExitModal, closeNavDrawer, closeoutItem,
  ...
  deleteBudgetLine, deleteBuildHistoryEntry, deleteCategoryBudget, deleteCategoryDetailRow,
  deleteLargeDiscLine, deleteLiability, deleteMappingRule, deleteNoteReceivable,
  deleteOtherAssetItem, deleteSavedScenarioSet, deleteTaxonomyCat, deleteTaxonomyGroup,
  ...
  renderNoteReceivableTable, renderOptimizerAllocationPanel, renderOptimizerOverrideTable,
  renderOptimizerPreviewNote, renderOptionalFunctions, renderOtherAssetItemsTable,
  ...
  renderRetirementIncome, renderRetirementWellness, renderReview, renderReviewCloseoutChecklist,
  renderRothConversion, renderRothMissingNotice, renderRothRows, renderSavedScenarioSetsHtml,
