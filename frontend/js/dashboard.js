...
Object.assign(window, {
  ...
  choiceHelpText, choiceLabel, choiceOptions, chooseDefaultDetailedSheet, classKey, clientDataKey,
  ...
  exitApp, expandAllDetailColumnsOnPage, expandAllDetailGroups, fetchPlanDataFiles, fetchText,
  fetchWithTimeout, fieldAllowedValues, fieldConnection, fieldDefaultMeaning,
  ...
  finiteOrNull, fmtPctCell, focusYtdAccountMoney, focusYtdTxnAmount, focusableEntries,
  getStrategyTab, goToStrategyTab, groupModelData, handleYtdTransactionUpload, helpList,
  hideSpendingModelLoadOverlay, hideUnusedTemplateCategories, hideYtdLoadOverlay, humanizeGroupKey,
  importPreviewList, irmaaModeValue, kpiHasValues, leverPctPoints, loadCanonicalGlossary,
  loadDetailedResults, makeYtdAccountRow, mergeDetailedSheetMeta, mergeProtectedClientData,
  moneyNegativeClass, moveToNextEntry, normalizePlanDataTextForCompare, normalizePlanningCaseRunType,
  ...
  openCachedChart, openExitModal, openNavDrawer, openNextCollapsedSectionFrom,
  optimizerOverrideTotalHtml, optimizerPreviewStatusCell, optimizerPreviewTarget,
  optionalModuleState, orderedRowsByLabel, pageHelp, pageSaveMode, pageSaveModeHtml, pageStatusHtml,
  parseCsvLine, parseCsvTable, parseDollarLike, percentDisplayDecimals, percentRaw, personCellInput,
  ...
  promotePlanningCase, readFileFromFolder, readYtdActualsPeriod, recoverPriorSpendingBudget,
  recoverYtdAccountSetup, rememberBuildCompare, renderAllocationRecommendation,
  renderAssetClassSelectionTable, renderAssetsCashReserves, renderCurrentAllocationModeNote,
  renderDetailedResultsNav, renderDetailedResultsProgressTick, renderDistributionStrategy,
  renderEntityCharitable, renderEstateWithAnnuityLink, renderFieldFinderGroups,
  renderHoldingPeriodSettingsHtml, renderHouseholdPeople, renderIncomeWork,
  ...
  renderPlanningLevers, renderPlanningWorkbench, renderRealLossAwarePanel,
  renderRealLossAwareTuningHtml, renderRetirementWellness, renderRothConversion,
  renderRothMissingNotice, renderRothRows, renderSpecialStrategies, renderSpendingDashboardOrLoad,
  renderSpendingWorkflowBanner, renderStateResidency, renderStrategyTabs,
  renderTangencyAllocationPanel, renderTotalWealthAllocationHtml, renderWithdrawalOrderTable,
  renderWithdrawalStrategy, renderWorkbenchLeverEditorHtml, renderWorkspaceSubtabsNav,
  renderYtdDuplicateReview, renderYtdSummary, renderYtdTracking, renderYtdTransactions,
  renderYtdTransactionsStep, renderYtdUploadPanel, resetAllocationPreview, resetYtdTxnPage,
  ...
  saveChanges, saveCurrentPlanToSelectedFolderForBuild, saveLiabilities, saveValueForRow,
  ...
  serializeLiabilities, setAllDetailColumnGroups, setAllocationSelectionMode, setCombinedSearch,
  setDetailedResultSheet, setDetailedResultsNavOpen, setNavSearch, setPlanningCaseActive,
  setPlanningLeverInput, setSearchScope, setSelectionAction, setStrategyTab, setYtdActualsPeriod,
  setYtdSort, setYtdTxnPage, showHelpAutoCollapseNoticeOnce, showPlanDataFileManifest,
  ...
  targetPctInput, toggleDetailColGroup, toggleDetailColumnGroup, toggleHelpSheet, toggleNavDrawer,
  translatePersonValueLabel, updateSearchToggle, updateYtdAccountMoney, updateYtdTxnAmount,
