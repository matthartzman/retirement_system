...
Object.assign(window, {
  ...
  buildSessionSummaryHtml, buildWithDesktopProgress, cacheChart, catEffectiveBudget,
  changeImpactScope, changeKey, chatMessageHtml, checkAppStatus, checklistItemStatus, choiceHelpText,
  choiceLabel, choiceOptions, chooseDefaultDetailedSheet, classKey, clearHousingNextStep,
  clientDataKey, cloneSummary, closeChartModal, closeExitModal, closeNavDrawer, closeoutItem,
  collapseAllDetailGroups, copyOptimizerOverrideToUserTargets, coreSpendingGrowthMode, csvEscape,
  currentManualOverrideItems, currentScenarioOverrideItems, currentSpendingTreeForDomain,
  decimalsFromText, deduplicateYtdTransactions, defaultPlanDataPath, deleteAllYtdTransactions,
  deleteBudgetLine, deleteCategoryBudget, deleteCategoryDetailRow, deleteLargeDiscLine,
  ...
  dollars0, domainBudgetNote, domainLineSections, downloadBlob, downloadFile, downloadYtdTemplate,
  ensurePlanFolderPermission, estimateHousingFromState, exitApp, expandAllDetailColumnsOnPage,
  ...
  importPlanDataContents, importPreviewList, inactiveRowsForStep, inactiveValueDisplay,
  inactiveValuesPanel, incomeStreamSubsections, irmaaModeValue, jumpRecommendationSource,
  kpiHasValues, largeDiscCategoryFromType, largeDiscTypeFromLine, leverPctPoints,
  ...
  mcEngineRow, mcEngineToggleHtml, mergeDetailedSheetMeta, mergeProtectedClientData, moneyHtml,
  ...
  revertLastBuildChanges, rollForwardYtdAccounts, rothPageRecommendations, rothPolicyValue,
  rowConfigValue, rowIsCanonicalHomeBasis, rowIsEconomyScenario, rowIsHomeSaleAssumption,
  rowIsRentInput, rowIsRetirementWellness, rowSortKeyForIncomeWork, rowValueIsMeaningful,
  rowsByLabel, rowsNotIn, saveAndExit, saveChanges, saveCurrentPlanToSelectedFolderForBuild,
