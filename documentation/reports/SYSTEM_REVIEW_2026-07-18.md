...
| §9.5-11 | Item 191 — what does "the attached" refer to? | **Investigate first** | Dispatch a research task: what "attached" means in the Scenario UI/schema, and whether any saved plan currently carries one. Not yet dispatched as of this entry. |
