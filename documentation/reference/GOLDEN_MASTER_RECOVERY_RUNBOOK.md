...
(`documentation/archive/superpowers/plans/2026-08-10-golden-master-and-at-rest-plan-data-migration.md`,
...
4. Prepends a dated entry to `documentation/reference/GOLDEN_MASTER_CHANGELOG.md`.
...
- `documentation/reference/GOLDEN_MASTER_CHANGELOG.md` — the record of every pin move
  and why.
- `documentation/reference/CLAUDE.md`, "Golden master maintenance" — links back here.
- `documentation/archive/superpowers/plans/2026-08-10-golden-master-and-at-rest-plan-data-migration.md`,
