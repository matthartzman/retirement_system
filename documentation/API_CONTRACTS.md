...
- `policy`: `enabled`, `source_dir`, `field_map_path`, `archive_consumed_files`.
...
- `POST /api/plan/monarch-autoupdate/run`: run the import now (`force: true` by default, bypassing the enabled check).
