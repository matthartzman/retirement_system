...
Picks up the "Not done" item in `documentation/reference/OPTIMIZATION_REFACTOR_STATUS.md`:
...
`documentation/future/superpowers/plans/2026-08-17-roth-conversion-gap-design.md`, "Interaction
...
`documentation/reference/GOLDEN_MASTER_CHANGELOG.md` states `optimize` is coerced
