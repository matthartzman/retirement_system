...
**Design spec:** `documentation/archive/superpowers/specs/2026-08-17-hsa-withdrawal-optimizer-design.md` (revision 3).
...
- Follow this repo's model/effort policy (`documentation/archive/reports/REMAINING_WORK_PLAN_2026-08-12.md` §5). Every task below carries an explicit assignment and a one-line reason.
...
**Files:**
- Modify: `tests/test_frozen_sample_plan_golden_master_regression.py`, `documentation/reference/GOLDEN_MASTER_CHANGELOG.md`
