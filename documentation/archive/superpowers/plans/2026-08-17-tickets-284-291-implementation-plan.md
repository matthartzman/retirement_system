...
| `documentation/reference/GOLDEN_MASTER_RECOVERY_RUNBOOK.md` (new) | 286 | procedure + known traps |
...
| `documentation/future/superpowers/plans/2026-08-17-roth-conversion-gap-design.md` (new) | 289 | unexecuted design |
...
`documentation/archive/superpowers/plans/2026-08-10-golden-master-and-at-rest-plan-data-migration.md`. There is no
...
- [ ] Subcommands:
      ...
      - `regen --reason <file>` — rewrite the two constants, **requiring** a non-empty justification
        file, and append a dated entry to `documentation/reference/GOLDEN_MASTER_CHANGELOG.md`.
...
### Step 4.3 — `documentation/reference/GOLDEN_MASTER_RECOVERY_RUNBOOK.md`
...
- [ ] Link it from `documentation/reference/CLAUDE.md` and from the pin file's docstring, or nobody will find it.
...
| `documentation/reference/CLAUDE.md:42` | prose path `C:\RetirementPlanning\Version 10 - ChatpGPT` |
...
- **Swept:** `src/`, `frontend/`, `tools/`, `launchers/`, `.claude/`, `documentation/reference/CLAUDE.md`.
...
- [ ] Note the wrinkle: `documentation/reference/CLAUDE.md` says `Version 10 - ChatpGPT`, not `Version 10`.
...
- [ ] Write `documentation/archive/superpowers/plans/2026-08-17-roth-guide-audit.md`.
...
Write `documentation/future/superpowers/plans/2026-08-17-roth-conversion-gap-design.md` covering:
