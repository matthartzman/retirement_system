...
**Spec:** `documentation/archive/superpowers/specs/2026-09-02-monarch-autoupdate-reporting-design.md`
...
- [ ] PowerShell (not Bash) for every Windows automation script, per stated
      preference.
- [ ] `documentation/reference/API_CONTRACTS.md` / `PROJECT_MANIFEST.md` updated for
