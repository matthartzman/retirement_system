...
**Files:**
- Read only: `input/*.csv`
- Create: `documentation/archive/superpowers/plans/2026-08-10-wellness-rename-inventory.md`
...
```bash
git add documentation/archive/superpowers/plans/2026-08-10-wellness-rename-inventory.md
