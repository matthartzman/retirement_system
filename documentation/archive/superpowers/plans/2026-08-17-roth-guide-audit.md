...
Ticket 289. Walks `documentation/reference/roth_conversion_modeling_guide.md` clause by
...
reviewed for the same reason, though rewriting `documentation/reference/roth_conversion_modeling_guide.md`'s
...
3. Design (not implementation) for both gaps — Step 8.3,
   `documentation/future/superpowers/plans/2026-08-17-roth-conversion-gap-design.md`, NOT executed.
