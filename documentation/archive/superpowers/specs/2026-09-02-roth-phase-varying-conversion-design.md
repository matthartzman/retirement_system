...
`documentation/archive/reports/SYSTEM_REVIEW_2026-08-31.md` §Wave 3, item 3.2 bundles several
...
- `input/client_policy.csv` — gitignored live/local client data (`.gitignore:35`,
  ...
  `documentation/reference/CLAUDE.md`'s canonical-source-hierarchy section. Any real saved
...
- `tests/fixtures/sample_plan_frozen/client_policy.csv`. Editing any golden-master
  ...
  `documentation/reference/GOLDEN_MASTER_RECOVERY_RUNBOOK.md` even for a nominally-no-op
