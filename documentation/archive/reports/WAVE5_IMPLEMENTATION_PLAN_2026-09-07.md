...
**Date:** 2026-09-07. **Source:** `documentation/archive/reports/SYSTEM_REVIEW_2026-09-07.md` §9 (Wave 4/5 table),
...
- **What:** Remove the version number from `documentation/reference/readme/README.md`'s heading entirely (the app
...
Per `documentation/reference/CLAUDE.md`: fast tier (`pytest tests/ -m "not slow" --tb=short -q`) after every item;
