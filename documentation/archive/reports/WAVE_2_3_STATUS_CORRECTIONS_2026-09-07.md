...
**Date:** 2026-09-07. **Source:** `documentation/archive/reports/SYSTEM_REVIEW_2026-09-07.md`, Wave 5 item W4-9
(findings ARC-2, N7, N8, ARC-3). Corrects how items 2.4, 2.5, 3.10, 3.12, and 3.13 — originally scoped in
`documentation/archive/reports/SYSTEM_REVIEW_2026-08-31.md` §9 (Waves 2-3) — were being described ("done"/"open"/
