...
def test_dashboard_top_level_groups():
    ...
    # #330 P8 / Q6 (W13): "Housing & Property" added -- Housing is a catalog
    # domain of its own, and Plan Features already groups its switches under
    # that name, so leaving the page under Spending was the mismatch this
    # workstream exists to close.
    assert groups == ["Plan Status", "People and Income", "Spending", "Housing & Property", "Assets & Protection", "Strategy", "Reports & Review", "Reports", "Settings"]
