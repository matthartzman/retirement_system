"""Coarse-descent correctness for src/housing_comparison.py (H13).

Renamed from test_housing_coordinate_descent_unit.py on 2026-09-16. That name
described src/housing/search.py, which these tests never touched, and the
housing-optimizer refinement plan duly rewrote the file in place for the new
coordinate search -- deleting this coverage of a still-live module. Restored
here under a name that says which module it actually guards.
